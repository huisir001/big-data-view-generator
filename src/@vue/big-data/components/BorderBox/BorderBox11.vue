 ...
 * @LastEditTime: 2020-09-08 14:41:23
-->
<template>
    <div class="border-box-11">
            ...
            <defs>
                <filter :id="filterId"
                    ...
                    <feMorphology operator="dilate"
                                  ...
                                  in="SourceAlpha"
                                  result="thicken" />
                    <feGaussianBlur in="thicken"
                                    stdDeviation="3"
                                    result="blurred" />
                    <feFlood :flood-color="color[1]"
                             result="glowColor" />
      ...
      `" />
        ...
        `">
            ...
            <text class="border-box-11-title"
                  :x="`${width / 2}`"
                  y="32"
                  fill="#fff"
                  font-size="18"
